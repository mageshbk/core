...
package org.switchyard.metadata.wsdl;
...
public final class WSDLService extends BaseService {
     ...
     */
    public static WSDLService fromWSDL(final String wsdlLocation) throws WSDLReaderException {
        return fromWSDL(wsdlLocation, null);
    }
