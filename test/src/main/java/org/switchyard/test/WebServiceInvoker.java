...
/**
 * A HTTP/SOAP Invoker for SOAP tests.
 *
 * @author Magesh Kumar B <mageshbk@jboss.com> (C) 2011 Red Hat Inc.
 */
public class WebServiceInvoker implements Callable<String> {

    private URL _serviceURL;
    private String _input;

    public WebServiceInvoker(URL serviceURL, String input) {
        _input = input;
    ...
    public String call() {
        ...
        try {
            ...
            outStream.write(_input.getBytes());
